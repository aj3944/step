...
while not stop:
	...
	if stable_x and stable_y:
		...
		# 	roll_y = -15;
			...
			right_leg_lift = 0;
			step_r = 0;
		mark_4.injest_ik_delay([roll_y + step_l - left_leg_lift,2*left_leg_lift,-roll_y - step_r + right_leg_lift,-2*right_leg_lift,kick_l,kick_r],50);
		# stop = True
		time.sleep(.1)
		mark_4.injest_ik_delay([roll_y + step_l + 0 ,0,-0 - 0,0,kick_l,kick_r],100);
		time.sleep(.1)
